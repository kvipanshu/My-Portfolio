...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs
        .sendForm('service_caslg9e', 'template_2syqkfj', form.current, {
          publicKey: 'KigkzbonnzWTXBvPY',
        })
        e.target.reset()
    };
    return(
                ...
                {/* <div className="contact__content">
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <span className="contact__card-data">vipanshu.srivastava28@gmail.com</span>

                            <a href="mailto:vipanshu.srivastava28@gmail.com" className="contact__button">Write Me
