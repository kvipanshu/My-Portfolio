...
const Data = () => {
    return(
        <div className="home__data">
            ...
            <p className="home__description">I'm a frontend developer based in India, and I'm passionate about crafting engaging user interfaces and seamless experiences for web applications.</p>
